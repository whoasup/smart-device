...
(() => {
  ...
  const maskPopupTel = (0,imask__WEBPACK_IMPORTED_MODULE_0__.default)(popupTel, telMaskOptions);

  const maskFeedbackTel = (0,imask__WEBPACK_IMPORTED_MODULE_0__.default)(feedbackTel, telMaskOptions);
